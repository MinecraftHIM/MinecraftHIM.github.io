	...
	<div class="container">
		...
		<div class="content">
			...
			<div class="section">
				...
				<ul>
					<li>
						<strong>生产操作员 | 立讯精密有限公司</strong><br> 2023.09 - 2023.12 - 苏州<br>-  机器报警处理及设备传送带、传感器维护维修。<br> - 操作定制可视化win系统组态界面 根据实际生产情况调节设备运行速率以及添加物料。<br> - 与线组长协作，确保产品数量质量达到要求并按时交付。
					</li>
					<li>
			...
			<div class="section">
				...
				<ul>
					<li>
						<strong>校内实训项目</strong><br> 2024.03 - 2024.06<br> - 设计并实现基于西门子S7-1200 PLC传送带自动化控制系统，包含启动、停止、速度调节功能。<br>- 使用梯形图编程并用电脑模拟运行成功。
					</li>
					<li>
