	...
	<div class="container">
		...
		<div class="content">
			...
			<div class="section">
				<h2>教育背景</h2>
	            <ul>
	            <li><strong>广西理工职业技术学院 | 大学专科</strong>
	            <br>2022.09-2025.06 电气自动化技术
	            <br>主修课程:可编程控制器技术 嵌入式系统开发 供配电技术 CAD制图 组态模拟等
	            </li>  
	            </ul>
				</div>
		    <div class="section">
			<h2>个人简介</h2>
			<p>本人有较强的自学能力 成绩专业前10% 在校期间参加校宣传部以及各种社团有一定组织能力 善于逻辑推理能独立思考. 熟练掌握专业课程知识 通过个人爱好自学Git分布式版本控制系统、MarkDown语言和网页开发语言、开发工具等。
			...
			<br>-机器报警处理及设备传送带、传感器维护维修。
			<br>-操作定制可视化win系统组态界面 根据实际生产情况调节设备运行速率以及添加物料。
			<br>-与线组长协作，确保产品数量质量达到要求并按时交付。
			</li>
...
```
        <li><strong>工程师管培生|华显光电(惠州)有限公司</strong>
		...
		<ul style="list-style-type: none;">
		    ...
		    <br> 2024.03 - 2024.06
		    <br>- 设计并实现基于西门子S7-1200 PLC传送带自动化控制系统，包含启动、停止、速度调节功能。
		    <br>- 使用梯形图编程并用电脑模拟运行成功。
			</li>
			<li>
